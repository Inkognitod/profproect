...
<link href="favicon.ico" type="image/x-icon" rel="shortcut icon" />
        ...
        <div class="block_success">					
            <h2 style="text-transform: uppercase;">Спасибо! Ваша заявка принята!</h2>
            <p class="success">
                В ближайшее время с вами свяжется наш юрист. Пожалуйста, включите ваш контактный телефон.
            </p>
            <h3 class="success">
            ...
            <div class="success">
                <ul class="list_info">
                    ...
                    <li><span>Имя: </span><span id="name"><?=$_GET['name']?></span></li>
                    <li><span>Email: </span><span id="email"><?=$_GET['email']?></span></li>
                </ul>
                <br/><span id="submit"></span>
            </div>
            <p class="fail success">Если вы ошиблись при заполнении формы, то, пожалуйста, <a href="javascript: history.back(-1);">заполните заявку еще раз</a></p>
